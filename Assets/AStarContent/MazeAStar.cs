...
public class MapLocation
{
    ...
    //Operator overload for adding 2 map locations
    public static MapLocation operator +(MapLocation a, MapLocation b) => new MapLocation(a.x + b.x, a.z + b.z);

    //Determines whether the passed in MapLocation is same as this objects map location
...
public class MazeAStar : MonoBehaviour
{
    [SerializeField]
    [Range(1, 10)]
    public int scale = 5;  //Appropriate Scale for my pieces 
    ...
    [SerializeField] Material wallColor;
    ...
    private void Generate(int x, int z)
    {
        ...
        */
        ...
        /** Generation using Reccursive Algo
    ...
    void ShuffleList()
    {
        List<MapLocation> tempList = new List<MapLocation>(directions);
    ...
    private void DrawMap()
    {
        ...
        for (int x = 0; x < size_X; x++)
        {
            for (int z = 0; z < size_Z; z++)
            {
                ...
                //MapLocation p = new MapLocation(x, z);
